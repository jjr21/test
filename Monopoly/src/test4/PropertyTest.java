...
public class PropertyTest {
	...
	public static void boxTrade() {
		...
		if(optionTrade ==0) {
			...
			if(optionTradePurple == 0){
				...
				int a =verifyProperty.getWhon(3);
				JOptionPane.showMessageDialog(null, "Player " + a + " own this property");
				if(currentTurn == a){
					JOptionPane.showMessageDialog(null, "You Own this property");
				}
				if(currentTurn != a){
					String input = JOptionPane.showInputDialog("How much do you offer for this property?");
					int offerA;
					offerA = Integer.parseInt(input);
					offerTradeCost(offerA, currentTurn, 3);
				}
				
			}
			if(optionTradePurple == 1){
				JOptionPane.showMessageDialog(null, "Trade -- Mediterranean Ave");
				int b =verifyProperty.getWhon(1);
				JOptionPane.showMessageDialog(null, "Player " + b + " own this property");
		...
		if(optionTrade ==1) {
			...
			if(optionTradeCyan == 0){
				...
				int c =verifyProperty.getWhon(9);
				JOptionPane.showMessageDialog(null, "Player " + c + " own this property");
			}
			if(optionTradeCyan == 1){
				JOptionPane.showMessageDialog(null, "Trade -- Oriental Ave");
				int d =verifyProperty.getWhon(6);
				JOptionPane.showMessageDialog(null, "Player " + d + " own this property");
			}
			if(optionTradeCyan == 2){
				JOptionPane.showMessageDialog(null, "Trade -- Vermont Ave");
				int e =verifyProperty.getWhon(8);
				JOptionPane.showMessageDialog(null, "Player " + e + " own this property");
			}
		}
		if(optionTrade ==2) {
	...
	public static void offerTradeCost(int Offer, int turn, int propertyArray){
		if(turn ==1){
			propertyInfo.MatchBoxArray(propertyArray);
			int offerTrade = JOptionPane.showConfirmDialog(null, "Player 1 offered " + propertyInfo.getArray() + "for " + Offer + " ?",
					"Trade Property House ", JOptionPane.YES_NO_OPTION);
			if (offerTrade == JOptionPane.YES_OPTION){
			JOptionPane.showMessageDialog(null, "Yes Confirmed");
			}
			else{
				JOptionPane.showMessageDialog(null, "NO Declined");
			}
		}
		if(turn ==2){
			propertyInfo.MatchBoxArray(propertyArray);
